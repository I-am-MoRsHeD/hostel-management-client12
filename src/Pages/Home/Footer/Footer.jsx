...
const Footer = () => {
    return (
        <div className='lg:mt-44 mt-10'>
            <Container>
                <div className='bg-sky-700 lg:h-64 md:h-44 h-36 flex flex-col lg:flex-row absolute w-10/12 md:w-[700px] lg:w-[1000px] lg:ml-3 ml-2 rounded-b-lg'>
                    <div className='border-t-2 lg:w-1/4 w-2/4 ml-28 lg:ml-10  mx-auto'>
                        <h5 className="lg:text-lg text-base border px-2 rounded-xl mt-1 w-3/4 text-center ">Invented:</h5>
                        <h2 className="lg:text-4xl text-xl lg:ml-14 ml-3 mt-2 text-white font-bold">From 2012</h2>
                    </div>
                    <div className='border-t-2 mt-2 lg:mt-0 mr-14 lg:mr-0 md:mr-0 w-2/4 mx-auto'>
                        ...
                        <h2 className="lg:text-4xl text-xl mt-2 text-white font-bold">Chattogram,Bangladesh</h2>
                    </div>
                </div>
